...
class GetBooksByTitleTest: AutoCloseKoinTest() {
    val repositoryModule = module {
        single<BookRepository> { MockRepositoryImpl() }
    }
    ...
    fun testGetBooksByTitle() {
        GetBooksByTitle(MockRepositoryImpl()).get("", 1, object : UseCase.Callback<List<Book>>{
...
class MockRepositoryImpl: BookRepository {
